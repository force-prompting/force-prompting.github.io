...
if __name__ == "__main__":
    ...
    for img_name in [
        "step-5000__file_id__balloon3__xpos_0.16__ypos_0.47__angle_0.00__force_0.50__video_0",
        "step-5000__file_id__toytrainontrack7__xpos_0.38__ypos_0.47__angle_0.00__force_0.50__video_0"
    ]:

        src_dir = "output/2025-04-07-point-force-unified-model/2025-04-18_08-57-25-ablation-1-ball/step-5000-videos"
        dst_dir = "scripts/2025-05-13-figures/ablation_dataset_diversity/ablation-1-ball/bad-model"
