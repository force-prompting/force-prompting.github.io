...
if __name__ == "__main__":
    ...
    for img_name in [
        "step-5000__file_id__campfire4__speed_0.67__angle_0.0__video_0",
        "step-5000__file_id__dress3__speed_0.67__angle_180.0__video_0"
    ]:

        src_dir = "output/2025-04-13-wind-force-updated-dataloader/2025-04-17_10-07-13-ablation-1-flag/step-5000-videos"
        dst_dir = "scripts/2025-05-13-figures/ablation_dataset_diversity/ablation-1-flag/bad-model"
